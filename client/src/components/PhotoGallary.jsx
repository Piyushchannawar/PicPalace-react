    ...
    <div className="my-20 bg-white flex flex-col justify-center items-center">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 bg-20">
        ...
        <ImageCard
          title="The unknown"
          author="coder29"
          img="https://images.pexels.com/photos/27945905/pexels-photo-27945905/free-photo-of-a-woman-with-red-hair-and-a-white-coat-standing-by-a-wall.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load"
          price={25}
          icon1={
            <FaShoppingCart className="text-2xl text-black cursor-pointer hover:scale-110 transition-all ease-linear duration-300" />
          }
